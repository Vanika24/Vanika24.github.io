...
.research-section { margin: 2rem 0 3rem; }
.research-item { margin: 1.5rem 0 2.5rem; }
.research-item h3 { margin: 0 0 .25rem; }
.research-meta { color:#6b7280; font-size:.95rem; margin-bottom:.5rem; }
.research-abstract { margin: .5rem 0 1rem; line-height:1.6; }
.pdf-embed { width: 100%; height: 640px; border: 1px solid #e5e7eb; border-radius: 12px; }
.pdf-caption { font-size:.9rem; color:#6b7280; margin:.5rem 0 0; }
/* optional compact spacing on mobile */
@media (max-width: 640px) { .pdf-embed { height: 520px; } }
</style>

## Publications

  <div class="research-section">
    <div class="research-item" id="pub-cambodia">
